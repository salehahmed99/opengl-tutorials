...
int main()
{
    ...
    // This draws a square using two triangles.
    // The common side is the side (bottom left - top right)
    // Note that the order here matters. glDrawArrays(GL_TRIANGLES, 0, 6) just walks through the buffer 3 vertices at a time
    // No implicit connections between triangles — each group of 3 is completely independent.
